...
func TestDetectAuthenticatorType(t *testing.T) {
	...
	assert.Equal(t, Macaroon, DetectAuthenticatorType(mac, api.APIType(Unknown)))
	assert.Equal(t, Rune, DetectAuthenticatorType(rune, api.APIType(Unknown)))
	assert.Equal(t, Unknown, DetectAuthenticatorType("", api.APIType(Unknown)))
	assert.Equal(t, Unknown, DetectAuthenticatorType("burek", api.APIType(Unknown)))
	assert.Equal(t, Unknown, DetectAuthenticatorType("0201036c6e640224030a10b4936084", api.APIType(Unknown)))
}
